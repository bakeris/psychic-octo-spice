            ...
            unless @bet.blank?
              ...
              request.on_complete do |response|
                if response.success?
                  ...
                  @error_code = '4003'
                  @error_description = 'Cannot acknowledge the bet.'
                end
              end
                    ...
                    if response.success?
                      ...
                      if !json_response.blank?
                        ...
                        if @error_code == 0 && (json_response["header"]["status"] == 'success' rescue nil)
                          ...
                          @error_code = '4005'
                          @error_description = 'Could not cancel the bet.'
                        end
                      else
                        @error_code = '4004'
                        @error_description = 'Error while parsing JSON acknowlegement response.'
                    ...
                    if response.success?
                      ...
                      if !json_response.blank?
                        ...
                        if @error_code == 0 && (json_response["header"]["status"] == 'success' rescue nil)
                          ...
                          @error_code = '4005'
                          @error_description = 'Could not refund the bet.'
                        end
                      else
                        @error_code = '4004'
                        @error_description = 'Error while parsing JSON acknowlegement response.'
